...
const ArtwoCaseStudy: React.FC = () => {
  useEffect(() => {
    window.location.href = 'https://dice-the-ticket-app-tryi-ji7cajv.gamma.site/';
  }, []);
    ...
    <main className="min-h-screen flex items-center justify-center bg-dutch-white">
      <div className="text-center px-6 max-w-xl">
        <h1 className="text-3xl font-bold mb-4 text-rich-black">
          Redirecting to Dice Case Study...
        </h1>
        ...
        <a
          href="https://dice-the-ticket-app-tryi-ji7cajv.gamma.site/"
          target="_blank"
